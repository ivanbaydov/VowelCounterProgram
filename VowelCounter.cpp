...
int main(int argc, char* argv[])
{
    ...
    cout << setfill('.') << setw(COLFMT1) << "The number of A's: " << A << endl
        << "The number of B's: " << B << endl
        << "The number of C's: " << C << endl
        << "The number of D's: " << D << endl
        << "The number of E's: " << E << endl
        << "The number of I's:" << I << endl
        << "The number of O's:" << O << endl
        << "The number of U's:" << U << endl
        << "The vowel count is: " << A + E + I + O +U << endl;
    return 0;
}
